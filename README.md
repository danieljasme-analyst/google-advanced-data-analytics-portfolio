# Google-Advanced-Data-Analytics-portfolio
 End-of-course portfolio projects for the Google Advanced Data Analytics Certificate — TikTok claims classification case study using Python - Google Advanced Data Analytics Certificate — Portfolio
